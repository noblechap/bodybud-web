...
**Use inline composables within components when:**
- Logic is specific to this component only (internal state management, computed values)
- Logic helps organize complex component logic into smaller, named functions
- The component is complex enough that extracting logic improves readability

**Extract to `src/composables/` when:**
- Logic is reusable across multiple components
- Logic is a common pattern (form validation, data formatting, etc.)
