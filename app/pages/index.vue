...
const feature1 = useTemplateRef("feature1");
const feature2 = useTemplateRef("feature2");
const feature3 = useTemplateRef("feature3");
const feature4 = useTemplateRef("feature4");
const cta = useTemplateRef("cta");

onMounted(() => {
  const isSafari = /^(?:(?!chrome|android).)*safari/i.test(navigator.userAgent);
  if (isSafari) {
    videoSrc.value = "/img/preview.mp4";
    videoType.value = "video/mp4";
  }
  else {
    videoSrc.value = "/img/preview.webm";
...
function setupObserver(element: HTMLElement | null, animationClass: string) {
  if (!element)
    return;
...
<template>
  ...
  <!-- Nutrition Tracking -->
  <section ref="feature1" class="feature-section">
  ...
  <!-- Workout Tracking -->
  <section ref="feature2" class="feature-section reverse">
    <div class="text-content">
      <h2 class="text-h3 text-md-h2 font-weight-bold mb-4">
        Smart Workout Logging
      </h2>
      <p class="text-h5 mb-4">
        Build, track, and analyze every workout.
      </p>
      <ul class="text-h6">
  ...
  <!-- Health Metrics -->
  <section ref="feature3" class="feature-section">
    <div class="text-content">
      <h2 class="text-h3 text-md-h2 font-weight-bold mb-4">
  ...
  <!-- Social Community -->
  <section ref="feature4" class="feature-section reverse">
    <div class="text-content">
      <h2 class="text-h3 text-md-h2 font-weight-bold mb-4">
  ...
  <!-- Final CTA -->
  <section ref="cta" class="cta-section">
    <h2 class="text-h3 text-md-h2 font-weight-bold mb-4">
      Ready to transform your fitness journey?
    </h2>
    <p class="text-h5 mb-8">
      Your complete bodybuilding toolkit awaits
    </p>
    <a
      href="https://apps.apple.com/us/app/bodybud/id6742726101"
      target="_blank"
