...
const currentDate = "March 04, 2025";
</script>
  ...
  <div class="privacy-policy">
    <div class="container">
      <div class="header">
        ...
        <img src="/img/logo.png" alt="BodyBud Logo" class="logo">
      </div>
      ...
      <ul>
        ...
        <li>
          <strong>Application</strong> refers to BodyBud, the software program
          provided by the Company.
        </li>
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We",
          "Us" or "Our" in this Agreement) refers to BodyBud.
        </li>
      ...
      <ul>
        <li>Email address</li>
        <li>
          Workout history (e.g., exercises performed, sets, reps, weights, and
          duration)
        </li>
        <li>Workout templates (e.g., pre-defined exercise routines)</li>
        <li>Meal templates (e.g., pre-defined meal plans and recipes)</li>
        <li>
          Body measurements (e.g., weight, height, body fat percentage, and
          other health metrics)
        </li>
        <li>
          Supplement usage (e.g., types of supplements, dosage, and frequency)
        </li>
        <li>Usage Data</li>
      </ul>
      <h4>Usage Data</h4>
